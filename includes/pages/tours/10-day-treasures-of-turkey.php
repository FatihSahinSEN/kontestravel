...
$data=array(
    ...
    "description" => "After Istanbul flight to Izmir. Visit House of Virgin Mary, Ephesus Ancient City and Pamukkale with its thermal pools. Departure from Fethiye for your unforgettable gulet cruise tour. 4 Day 3 Nights on Board. You will stay in old city and visit Ancient Perge and amazing Aspendos Theatre in Antalya. Delicious open buffet breakfast and free wi-fi at the hotels. In Cappadocia visit Goreme Open Air Museum, Derinkuyu underground City and more… Flight back to Istanbul.",
    "lang" => "en",
    "price" => "1169",
    "tour_plan" => array(
        1 => array(
        ...
        2 => array(
          "day" => "DAY 2",
          "title" => "Pamukkale Tour / Travel to Fethiye (B,L) (FETHIYE)",
...
<br /><br />
After the tour in Pamukkale drive to bus terminal in Denizli for a public bus to Fethiye. On arrival in Fethiye you will catch a taxi to your hotel in the harbour.",
        ),
        3 => array(
          "day" => "DAY 3",
          "title" => "Day 3– Fethiye to St. Nicholas Island (B,L,D) (ON BOARD)",
          "description" => "Transfer from your hotel to embark on your gulet and cruise to Samanlik Bay for swimming, lunch or depending on the sea conditions to Butterfly Valley. A swim and optional visit of this natural reserve, hosting 136 kinds of different butterflies and moths. Afterwards we cruise to Oludeniz (The Blue Lagoon) again sea conditions permitting. Option for paragliding available. Last stop of the day is St.Nicholas Island with its Byzantine ruins. Chance for swimming followed by dinner on board. ",
        ),
        4 => array(
          "day" => "DAY 4",
          "title" => "St. Nicholas Island to Kas (B,L,D) (ON BOARD)",
          "description" => "Around sunrise departure to Aquarium or Firnaz Bay near Kalkan for breakfast and a swim. Cruising to Kas where we stop in the harbour for lunch and visit this charming fishing village. Kas was once known as ancient Antiphellos of which Lycian rock tombs, sarcophagi and Roman theatre over looking to Mediterranean are now left. But the charm of the town remains!  In a bay near Kekova-Sunken city we stop for swimming and diner on board. ",
        ),
        5 => array(
          "day" => "DAY 5",
          "title" => "Kas to Gokkaya Bay (B,L,D) (ON BOARD)",
          "description" => "Departure to Sunken City of Kekova (this Lycian-Roman archaeological site is UNESCO protected, so only looking!). Lunch by Simena, a traditional Turkish fishing village with no car access and Byzantine-Ottoman castle. In Gokkaya Bay optional water sports are available. Dinner, relax in this pirates haven or party the night away at the Smugglers Inn. ",
        ),
        6 => array(
          "day" => "DAY 6",
          "title" => "Transfer to Antalya (B) (ANTALYA)",
          "description" => "After breakfast we have a look at the Pirates Cave (sea conditions permitting) before cruising to Andriace harbour. Disembark from our gulet and private transfer to Antalya old city. ",
        ),
        7 => array(
          "day" => "DAY 7",
          "title" => "Perge, Aspendos, Side Tour (B,L) (ANTALYA)",
          "description" => "Today in the morning we will drive to Perge Ancient City, which is a biblical site as St. Paul passed through this very well-preserved Roman city with stil standing Roman baths, Gymnasium and Agora. Then drive to one the best preserved Greco-Roman Amphitheater at Aspendos. On the way back to Antalya stop at Side where the temple of Athena & Apollo by the seaside. ",
        ),
        8 => array(
          "day" => "DAY 8",
          "title" => "Bus Travel to Cappadocia / See The Countryside (B) (GOREME)",
          "description" => "Check-out in the morning and transfer to Antalya Bus Terminal and public bus to Cappadocia with driving over legendary Taurus mountains as the country side view dramaticly changed during the drive. On arrival in Goreme transfer to your hotel. ",
        ),
        9 => array(
          "day" => "DAY 9",
    ...
    "tour_info" => array(
      "tour_destinations" => "Ephesus, Pamukkale, Fethiye-Olympos gulet Cruise, Antalya, Cappadocia",
      "tour_price_list" => "Per Person in Double Room : 1.169 €
...
Fethiye : Yacht Boheme Hotel or Similar
On Gulet Cruise
Antalya : 1207 Boutique Hotel or Similar 
Goreme : Goreme House Hotel or Similar",
      "tour_price_includes" => "* 1 Night hotel in Kusadasi
* 1 Night hotel in Fethiye 
* 3 Nights on Gulet Cruise 
...
* Private transfer from Gulet to hotel in Antalya
* Bus tickets from Antalya to Cappadocia
* Flight tickets from Cappadocia to Istanbul
* 1 Airport transfer in Istanbul
* 1 Airport transfer in Izmir
* 1 Private transfer to Antalya otogar
* 1 Airport transfer in Cappadocia
* Ephesus – Small Group Tour (incl. guiding, lunch, entry fees )
* Pamukkale – Small Group Tour (incl. guiding, lunch, entry fees )
* 4 Days / 3 Nights Fethiye to Olympos Gulet Cruise Tour
* Antalya – Small Group Tour (incl. guiding, lunch, entry fees )
