...
$data=array(
    "title" => "TURKEY BEAUTY TOUR",
    "description" => "Istanbul !! The Queen of the cities. Visit amazing Hagia Sophia and Topkapi Palace. After Istanbul travel to Gallipoli. Overnight stay in Canakkale-Dardanelle than continue to Troy and Pergamon. Visit House of Virgin Mary, Ephesus Ancient City and Pamukkale with its thermal pools. Direct flight to Cappadocia and 2 nights stay at boutique cave hotel. Delicious open buffet breakfast and free wi-fi at the hotels. In Cappadocia visit Goreme Open Air Museum, Derinkuyu underground City and more… Flight back to Istanbul.",
    "lang" => "en",
    "price" => "979",
    "tour_plan" => array(
        1 => array(
...
Transfer from airport or cruise port to your hotel by private car. The rest of the day at your leisure. ",
        ...
        7 => array(
          ...
          "description" => "Today we check out and transfer to Izmir Airport for a flight to Kayseri-Cappadocia. On arrival to Kayseri Airport, you will be transferred  to your cave hotel. The rest of the day at your leisure. Evening in Goreme. ",
        ),
        8 => array(
          "day" => "DAY 8",
        ...
        9 => array(
          "day" => "DAY 9",
          "title" => "North Cappadocia Tour / Flight to Istanbul (B,L) (ISTANBUL)",
    ...
    "tour_info" => array(
      "tour_destinations" => "Istanbul, Gallipoli, Troy, Pergamon, Ephesus, Pamukkale, Cappadocia",
      "tour_price_list" => "Per Person in Double Room : 979 €
