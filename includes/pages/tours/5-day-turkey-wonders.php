...
$data=array(
    "title" => "TURKEY WONDERS TOUR",
    "description" => "Visit House of Virgin Mary, Ephesus Ancient City and Pamukkale with its thermal pools. Travel by flight to Cappadocia. Stay 2 nights at boutique cave hotel in Goreme. Delicious open buffet breakfast and free wi-fi at the hotels. In Cappadocia visit Goreme Open Air Museum, Derinkuyu underground City and more…",
    "lang" => "en",
    "price" => "769",
    "tour_plan" => array(
        1 => array(
          "day" => "DAY 1",
          "title" => "Flight to Izmir/Ephesus Tour (L) (KUSADASI)",
          "description" => "Early morning transfer to the airport for fly to Izmir. On arrival to Izmir Airport, you will be transferred to Ephesus-Selcuk to join the Ephesus day trip. On tour; visiting the Greco – Roman City of Ephesus which is one of the best preserved ancient Roman city in the world. Then drive up to the House of Virgin Mary where it is believed she spent her final days. This is an official pilgrimage and holy place for Christians. After lunch we visit Temple of Artemis and Greek Wine Village Sirince.",
        ),
        2 => array(
          "day" => "DAY 2",
    ...
    "tour_info" => array(
      "tour_destinations" => "Ephesus, Pamukkale, Cappadocia",
      "tour_price_list" => "Per Person in Double Room : 669 €
...
Goreme : Goreme House Hotel or Similar",
      "tour_price_includes" => "* 2 Nights hotel in Kusadasi
