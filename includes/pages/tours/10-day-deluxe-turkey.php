...
$data=array(
    "title" => "DELUXE TURKEY TOUR",
    "description" => "Istanbul !! The Queen of the cities. Visit amazing Hagia Sophia and Topkapi Palace. After Istanbul travel to Gallipoli. Overnight stay in Canakkale-Dardanelle than continue to Troy and Pergamon. Visit House of Virgin Mary, Ephesus Ancient City and Pamukkale with its thermal pools. Ancient Perge and amazing Aspendos Theatre in Antalya. Delicious open buffet breakfast and free wi-fi at the hotels. In Cappadocia visit Goreme Open Air Museum, Derinkuyu underground City and more… Flight back to Istanbul.",
    "lang" => "en",
    "price" => "999",
    "tour_plan" => array(
        1 => array(
        ...
        2 => array(
          "day" => "DAY 2",
          "title" => "Private Istanbul Old City Tour (B,L) (ISTANBUL)",
          "description" => "Your guide will be meeting you in the lobby at your hotel at 9 am. We will start our day from the hearth of the old city with visiting; The Byzantine Hippodrome where the Egyptian Obelisk standing, Blue Mosque, Hagia Sophia, Topkapi Palace (Harem not included) and Grand Bazaar. ",
        ),
        3 => array(
          "day" => "DAY 3",
          "title" => "Gallipoli Tour (B,L,D) (CANAKKALE)",
          "description" => "We will check-out and travel to Gallipoli through the beautiful landscape of Thrace. Lunch on arrival in Eceabat by Dardanelles. After lunch we will visit WWI Memorials; Anzac Cove, original tunnels and trenches at Johnston Jolly, The Nek Cemetery, Chunuk Bair- New Zealand Memorial, Lone Pine Cemetery-Australian Memorial and Brighton Beach. ",
        ),
        4 => array(
          "day" => "DAY 4",
          "title" => "Troy, Pergamon Tour (B,L) (KUSADASI)",
          "description" => "We will start our day with ancient city of Troy after a short drive which is an UNESCO World Heritage site and one of the world's most important archaelogical sites. After Troy we  proceed to Pergamon. Explore Athena and Trojan Temples, Altar of Zeus and  Dionysos, Gymnasium of Youth, Odeon, Library, Agora, Great Hellenistic Theatre, Roman Bath and visit ancient health center of  Asclepion. After our visits, drive to Kusadasi. ",
        ),
        5 => array(
          "day" => "DAY 5",
          "title" => "Ephesus Tour (B,L) (KUSADASI)",
          "description" => "Today we will visit the Greco – Roman City of Ephesus which is one of the best preserved ancient Roman city in the world. Then drive up to the  House of Virgin Mary where it is believed she spent her final days. This is an official pilgrimage and holy place for Christians. After lunch we visit Temple of Artemis and Greek Wine Village Sirince.  ",
        ),
        6 => array(
          "day" => "DAY 6",
          "title" => "Pamukkale Tour / Travel to Antalya (B,L) (ANTALYA)",
...
After the tour in Pamukkale drive to bus terminal in Denizli for a public bus to Antalya. On arrival in Antalya you will catch a taxi to your hotel in the old city.  ",
    ...
    "tour_info" => array(
      "tour_destinations" => "Istanbul, Gallipoli, Troy, Pergamon, Ephesus, Pamukkale, Antalya, Cappadocia",
      "tour_price_list" => "Per Person in Double Room : 999 €
...
Canakkale : Akol Hotel or Similar
...
* Bus tickets from Pamukkale to Antalya
...
* 1 Private transfer to Antalya otogar from hotel
* Istanbul – Private Old City Tour (incl. private guiding, lunch, entry fees )
* Gallipoli, Troy, Pergamon – Small Group Tour (incl. guiding, lunch, entry fees )
